...
export const FACTIONS: Record<string, Faction> = {
  "the-purists": {
    ...
    bonuses: [
      {
        type: "LOGIC_PRECISION",
        value: 0.2,
        description: "Bônus de precisão em lógica.",
      },
    ],
    ranks: [],
    ...
    bonuses: [
      {
        ...
        value: 0.3,
        description: "Compilação 30% mais rápida.",
      },
    ],
    ranks: [],
    ...
    bonuses: [
      {
        ...
        value: 0.25,
        description: "25% de desconto em operações de sistema.",
      },
    ],
    ranks: [],
  ...
  "void-runners": {
    ...
    bonuses: [
      { type: "XP_BOOST", value: 0.15, description: "+15% de ganho de XP." },
    ],
    ranks: [],
