...
export default function FactionsPage() {
  ...
  if (loading) return <div className="p-8 text-cyan-500 animate-pulse">VERIFICANDO CREDENCIAIS...</div>;
  ...
  return (
    <div className="min-h-screen bg-black p-6 text-white">
      <header className="mb-12">
        ...
        <p className="text-slate-500 font-mono text-sm mt-2">Escolha a sua linhagem de processamento.</p>
      </header>
        ...
        {Object.values(FACTIONS).map((f) => (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div style={{ color: f.primaryColor }} className="p-3 bg-slate-800 rounded-xl">
                <Target size={24} />
              </div>
              <span style={{ backgroundColor: f.primaryColor }} className="px-2 py-1 text-[10px] font-bold text-black rounded">
                DISPONÍVEL
              </span>
            </div>
